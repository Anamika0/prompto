...
<h1 className='head_text text-left'>
  <span className='black_gradient'>
    ...
    <p className="desc text-left max-w-md">
      {type} and share amazing prompts with the world and let your imagination shine with any AI-powered platform
    </p>
<form onSubmit={handleSubmit} className='mt-10 w-full max-w-2xl flex flex-col gap-7 glassmorphism'>
  ...
  <label htmlFor="">
    ...
    <span className='font-normal'>(#product,#webdeveopment,#idea)</span></span>
  ...
  <div className="flex-end mx-3 b-5 gap-4">
    ...
    <button type="submit" className='px-5 py-1.5 text-sm pink_gradient_button rounded-full text-white' disabled={submitting}>
